...
//Init ----------------------------------------------------------------
void i2c_init() //an Taktleitung anpassen
{
...
char i2c_tx(char data, char successState)
{
	...
	return ((TWSR & 0xF8) == successState); // == MT_SLA_ACK, SLA+W has been transmitted; ACK received -> True wenn successState mit TWSR übereinstimmt
